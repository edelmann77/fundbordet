...
/** Maps a Theme object to a CSS string of custom properties. */
const themeToCssVars = (theme: Theme): string => {
  return [
...
export const ThemeProvider: React.FC<{
  theme?: Theme;
  children: ReactNode;
}> = ({ theme = outdoorTheme, children }) => {
  return (
    <ThemeContext.Provider value={theme}>
      <style
        dangerouslySetInnerHTML={{
          __html: `.tf-theme-root{${themeToCssVars(theme)}}`,
        }}
      />
      <div className="tf-theme-root">{children}</div>
